  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        ...
        <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-lg shadow-orange-500/30">
          <defs>
      ...
      {showText && (
        <div className="flex flex-col">
          <span className="text-xl lg:text-2xl font-black tracking-tighter bg-gradient-to-r from-orange-600 to-amber-500 bg-clip-text text-transparent uppercase">
            kHyAtI-7
          </span>
